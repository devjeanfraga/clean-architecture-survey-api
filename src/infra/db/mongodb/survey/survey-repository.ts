...
import { AddSurveyModel, AddSurveyRepository } from "../../../../data/usecases/db-add-survey/db-add-survey-protocols";
import { LoadSurveysRepository, SurveyModel } from "../../../../data/usecases/db-load-surveys/db-load-surveys-protocols";
